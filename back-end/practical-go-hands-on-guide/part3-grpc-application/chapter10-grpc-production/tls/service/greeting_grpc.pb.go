...
const (
	Greeting_SayHi_FullMethodName = "/Greeting/SayHi"
)
...
type GreetingClient interface {
	SayHi(ctx context.Context, in *User, opts ...grpc.CallOption) (*GreetMessage, error)
}
...
func (c *greetingClient) SayHi(ctx context.Context, in *User, opts ...grpc.CallOption) (*GreetMessage, error) {
	out := new(GreetMessage)
	err := c.cc.Invoke(ctx, Greeting_SayHi_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetingServer interface {
	SayHi(context.Context, *User) (*GreetMessage, error)
...
func (UnimplementedGreetingServer) SayHi(context.Context, *User) (*GreetMessage, error) {
...
func _Greeting_SayHi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Greeting_SayHi_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetingServer).SayHi(ctx, req.(*User))
	}
